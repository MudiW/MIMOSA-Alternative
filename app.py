...
def lights(position, pi):
    ...
    send_request2(pi, 0, 64, [255, 0, 0])
    send_request(pi, start_num, int(position), [0, 255, 0])
    time.sleep(2) # Change how long the LED stays on for.
    send_request2(pi, 0, 64, [255, 255, 255])
    send_request(pi, 0, 64, [255, 255, 255])
